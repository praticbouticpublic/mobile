...
export class PresentationtableComponent {
    ...
    goToUpdatePage(table: any, id: any, selcol: any, selid: any) {
        ...
        if (this.model.getTableParNom(table).sstable === 'o') {
            this.router.navigate(['admin/update/updaterecord/' + table + '/' + id + '/' + selcol + '/' + selid], { replaceUrl: true });
        }
        else {
            this.router.navigate(['admin/updaterecord/' + table + '/' + id + '/' + selcol + '/' + selid], { replaceUrl: true });
        }
    }
    ...
    goToViewPage(table: any, id: any, selcol: any, selid: any) {
        ...
        this.router.navigate(['admin/viewrecord/' + table + '/' + id + '/' + selcol + '/' + selid], { replaceUrl: true });
    }
