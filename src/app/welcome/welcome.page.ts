...
import { AlertController, isPlatform, MenuController, Platform, IonHeader, IonImg, IonContent, IonItem, IonSelect, IonSelectOption, IonLabel, IonFabButton, IonIcon, IonButton } from '@ionic/angular/standalone';
            ...
            buttons: [
                {
                    text: 'OUI',
                    handler: data => {
                        this.router.navigate([str], { replaceUrl: false });
                    }
                },
                {
                    text: 'NON',
