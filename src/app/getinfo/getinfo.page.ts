...
import { AlertController, MenuController, IonHeader, IonCard, IonImg, IonToolbar, IonTitle, IonContent, IonSpinner, IonItem, IonInput, IonRadioGroup, IonRadio, IonLabel, IonCheckbox, IonTextarea, IonFooter, IonButton } from '@ionic/angular/standalone';
...
@Component({
    ...
    imports: [IonicModule, FormsModule, ReactiveFormsModule, RouterLink, DecimalPipe]
})
export class GetinfoPage implements OnInit {
    ...
    constructor(public httpClient: HttpClient, public alert: AlertController, public router: Router, public route: ActivatedRoute,
        public order: OrderService, public session: SessionfrontService, public fb: FormBuilder, public initsession: InitSession,
    ...
    ngOnInit(): void {
        ...
        this.getinfoFormGroup = this.fb.group({
            ...
            codepromo: ['', [Validators.pattern('[0-9A-Z]{4}')]],
