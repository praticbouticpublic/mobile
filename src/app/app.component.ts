...
export class AppComponent {
    ...
    constructor(location: Location, public platform: Platform,
        public router: Router, public zone: NgZone, public getback: GetbackService, public model: ModeleService,
        public storage: StorageService, public httpClient: HttpClient, public alertController: AlertController,
        public global: GlobalService, public msg: MessageService, public chkver: CheckversionService,
        public activeroute: ActivatedRoute, public header: HeaderService) {
