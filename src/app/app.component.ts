...
export class AppComponent implements AfterViewInit {
    ...
    constructor(location: Location, public platform: Platform,public router: Router, public zone: NgZone,
        ...
        public msg: MessageService, public chkver: CheckversionService, public activeroute: ActivatedRoute,
        public header: HeaderService, private gestureCtrl: GestureController, private menuCtrl: MenuController) {
