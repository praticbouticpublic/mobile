...
import { MenuController, AlertController, Platform, isPlatform, IonRouterOutlet, IonicSafeString } from '@ionic/angular/standalone';
...
export class LoginPage implements OnInit {
    ...
    constructor(private router: Router, public menuCtrl: MenuController, private httpClient: HttpClient,
        ...
        public session: InitSession, private sessionback: SessionbackService,
