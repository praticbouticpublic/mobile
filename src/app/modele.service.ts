...
export class ModeleService {
  ...
  getLiens()
  {
    ...
    async insertrow ( bouticid: any, table: any, row: any): Promise<Observable<string>>
  {
  ...
  async updaterow(bouticid: any, table: any, row: any, pknom: any, idtoup: any, form: any): Promise<void>
  {
    const obj = { bouticid, table, colonne:pknom, row, idtoup };
    this.httpClient.post(environment.apiroot + 'update-row', obj, await this.header.buildHttpOptions())
