...
export class PaiementPage implements OnInit {
    ...
    constructor(public httpClient: HttpClient, public alert: AlertController, public router: Router, public route: ActivatedRoute,
        public order: OrderService, public session: SessionfrontService, public initsession: InitSession, public menuCtrl: MenuController,
            ...
            .subscribe((result: any) => {
                ...
                if (result.error) {
                    ...
                    if (result.paymentIntent.status === 'succeeded') {
                        ...
                        this.router.navigate(['admin/fin']);
                    }
                }
            });
    }
            ...
            buttons: [
                {
                    text: 'OK',
                    handler: data => {
                        this.router.navigate(['admin/debut/' + this.session.getAliasBoutic(true) + '/' + this.session.getMethod(true) + '/' + this.session.getTable(true)])
                    }
                }
            ],
        });
