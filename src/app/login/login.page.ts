...
import { MenuController, AlertController, Platform, isPlatform, IonRouterOutlet, IonicSafeString, IonHeader, IonToolbar, IonImg, IonTitle, IonContent, IonSpinner, IonLabel, IonItem, IonInput, IonIcon, IonRow, IonCol, IonButton, IonChip, IonFooter } from '@ionic/angular/standalone';
...
export class LoginPage implements OnInit {
    ...
    constructor(private router: Router, public menuCtrl: MenuController, private httpClient: HttpClient,
        ...
        public session: InitSession, private sessionback: SessionbackService, public selparam:SelparamService,
